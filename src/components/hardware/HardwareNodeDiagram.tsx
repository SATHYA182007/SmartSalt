...
export const HardwareNodeDiagram: React.FC = () => {
  return (
    <div className="relative bg-gradient-to-b from-slate-50 via-white to-teal-50/40 border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-xs overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div className="w-full lg:w-1/2 flex justify-center">
          <div className="relative w-full max-w-md bg-white rounded-2xl border border-slate-200 p-4 sm:p-5 shadow-xs flex items-center justify-center">
            <svg viewBox="0 0 500 540" className="w-full h-auto drop-shadow-md">
              {/* Sky Background */}
              <rect x="10" y="10" width="480" height="310" rx="16" fill="#F0FDFA" />

              {/* Salt Evaporation Pond Water */}
              <path d="M 10 300 Q 250 280 490 300 L 490 530 L 10 530 Z" fill="#67E8F9" opacity="0.6" />
              <path d="M 10 330 Q 250 315 490 330 L 490 530 L 10 530 Z" fill="#0891B2" opacity="0.75" />

              {/* Salt Crust Texture along shoreline */}
              <path d="M 10 300 Q 150 295 250 305 T 490 300 L 490 320 Q 250 310 10 320 Z" fill="#FFFFFF" opacity="0.9" />

              {/* FRP Corrosion Resistant Mast Pole */}
              <rect x="235" y="80" width="18" height="340" rx="4" fill="#475569" stroke="#1E293B" strokeWidth="2" />
              <rect x="238" y="80" width="4" height="340" fill="#94A3B8" />
              ...
              <g transform="translate(170, 40)">
                ...
                <polygon points="14,23 136,23 122,8 28,8" fill="#0F766E" />
                {/* Grid lines */}
                <line x1="75" y1="5" x2="75" y2="25" stroke="#2DD4BF" strokeWidth="1" />
                <line x1="45" y1="14" x2="105" y2="14" stroke="#2DD4BF" strokeWidth="1" />
              </g>

              {/* LoRa Antenna */}
              <g transform="translate(240, 5)">
                <rect x="2" y="0" width="4" height="60" fill="#0F172A" rx="2" />
                <circle cx="4" cy="2" r="3" fill="#0D9488" />
                {/* LoRa signal waves */}
                <circle cx="4" cy="2" r="10" fill="none" stroke="#06B6D4" strokeWidth="1.5" opacity="0.6" strokeDasharray="3 3" />
                <circle cx="4" cy="2" r="18" fill="none" stroke="#0D9488" strokeWidth="1.5" opacity="0.4" strokeDasharray="4 4" />
              </g>
              ...
              <g transform="translate(200, 130)">
                ...
                <text x="24" y="42" fill="#2DD4BF" fontSize="10" fontFamily="monospace" fontWeight="bold">
                  185mS
                </text>
              ...
              <g transform="translate(225, 240)">
                ...
                {/* Heavy Duty Cables */}
                <path d="M 12 14 C 12 80 55 110 55 150" fill="none" stroke="#0F172A" strokeWidth="4" />
                <path d="M 26 14 C 26 60 -15 90 -15 140" fill="none" stroke="#0D9488" strokeWidth="4" />
              </g>
              ...
              <g transform="translate(270, 390)">
                ...
                <rect x="4" y="38" width="12" height="8" fill="#2DD4BF" />
                <circle cx="10" cy="42" r="2" fill="#FFFFFF" />
                <text x="-15" y="-8" fill="#0F172A" fontSize="11" fontWeight="bold" fontFamily="sans-serif">
                  EC / Salinity Probe
                </text>
              </g>
              ...
              <g transform="translate(195, 380)">
                <rect x="0" y="0" width="16" height="55" rx="3" fill="#0D9488" />
                <circle cx="8" cy="45" r="4" fill="#F59E0B" />
                <text x="-65" y="-8" fill="#0F172A" fontSize="11" fontWeight="bold" fontFamily="sans-serif">
                  Temp & Level Sensor
                </text>
              </g>
            </svg>
        ...
        <div className="w-full lg:w-1/2 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50/80 border border-teal-200/80 text-teal-800 text-xs font-bold">
            <Shield className="w-3.5 h-3.5 text-teal-600" /> IP67 / IP68 Corrosion Isolated Engineering
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
            ...
            <div className="p-3 rounded-xl bg-white border border-slate-200 flex items-start gap-3">
              <Radio className="w-5 h-5 text-cyan-600 shrink-0 mt-0.5" />
              <div>
