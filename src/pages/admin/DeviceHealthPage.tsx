    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-slate-900">Hardware & Device Health Diagnostics</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs">
          ...
          <div className="text-2xl font-black text-blue-600 mt-1">-68 dBm Avg</div>
        ...
        <div className="divide-y divide-slate-100">
          {nodes.map((node) => (
            <div key={node.id} className="py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
              <div className="flex items-center gap-3">
                <span className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 font-bold flex items-center justify-center">
                  {node.id.slice(-2)}
                </span>
                <div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-slate-700 font-semibold">
                ...
                <span>Signal: <strong className="text-blue-600">{node.signalDbm} dBm</strong></span>
